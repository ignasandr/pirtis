...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='audio file looper')
    ...
    # cwd = os.getcwd()
    sound_file_paths = [
        os.path.join(args.dir, path) for path in sorted(filter(lambda path: good_filepath(path), os.listdir(args.dir)))
    ]
